...
<!--
  ...
  assets at /web-demo/2026-07-10/, so SharedArrayBuffer is available.
  ...
  repo at /web-demo/2026-07-10/ and loaded from the same origin via
...
<script async src="{{ '/web-demo/2026-07-10/openlierox.js' | relative_url }}"></script>
{:/nomarkdown}
